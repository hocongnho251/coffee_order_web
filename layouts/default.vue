    ...
    <v-navigation-drawer v-if="isLogged" app color="#F8EFE5">
      ...
      <v-list dense>
        ...
        >
          ...
          <v-list-item-content>
            <v-list-item-title class="#303030--text font-weight-bold">{{
              item.title
            }}</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-divider color="#303030"></v-divider>
        <v-btn block @click.stop="logout" color="#F8EFE5">
          {{ $t("admin.logout") }}
        </v-btn>
        <v-divider color="#303030"></v-divider>
      </v-list>
  ...
  data() {
    return {
      items: [
        ...
        {
          title: this.$i18n.t("admin.staff"),
          icon: "mdi-account",
          to: "/staff"
        },
        {
          title: this.$i18n.t("admin.customer"),
          icon: "mdi-account-group-outline",
          to: "/customer"
        },
        {
          title: this.$i18n.t("admin.table"),
          icon: "mdi-table-large",
          to: "/table"
        },
        {
          title: this.$i18n.t("admin.menu"),
          icon: "mdi-account-group-outline",
          to: "/menu"
        },
        {
          title: this.$i18n.t("admin.table_manager"),
          icon: "mdi-account-group-outline",
          to: "/tables"
        },
        {
